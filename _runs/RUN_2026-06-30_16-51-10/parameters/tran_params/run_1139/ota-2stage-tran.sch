...
let vena_limit=0.5*1.45
meas tran tstart WHEN v(v_ena)=vena_limit
let tsettle=tcross-tstart

echo $&tsettle > /home/sriram/MCD_VS/_runs/RUN_2026-06-30_16-51-10/parameters/tran_params/run_1139/ota-2stage-tran_1139.data
.endc
"}
C {devices/vsource.sym} 700 -210 0 0 {name=Vdd value=1.45}
...
C {devices/vsource.sym} 880 -420 0 0 {name=Vin value=0.8}
...
.lib cornerRES.lib res_p
.lib cornerCAP.lib cap_p
"}
