...
N 130 -10 130 60 {lab=bias}
N 130 -10 170 -10 {lab=bias}
N -550 160 -550 180 {
lab=GND}
...
N -480 -500 -480 -430 {lab=bias}
N -480 -500 -440 -500 {lab=bias}
N 270 -470 270 -400 {lab=bias}
N 270 -470 320 -470 {lab=bias}
N 810 -440 810 -380 {lab=bias}
...
C {iopin.sym} 130 60 0 1 {name=p24 lab=bias
}
...
C {iopin.sym} 970 -610 0 1 {name=p16 lab=vdd
}
...
C {iopin.sym} -480 -430 0 1 {name=p17 lab=bias
}
C {iopin.sym} 270 -400 0 1 {name=p18 lab=bias
}
C {iopin.sym} 810 -380 0 1 {name=p25 lab=bias
}
